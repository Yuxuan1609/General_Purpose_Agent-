...
def load_config(config_path: str = "config.yaml") -> AgentConfig:
    ...
    return AgentConfig(
        ...
        l1_rules_path=Path(raw.get("l1_rules_path", "./data/layers/l1_rules.json")),
        skills_dir=Path(raw.get("skills_dir", "./data/layers/skills")),
        knowledge_dir=Path(raw.get("knowledge_dir", "./data/layers/knowledge")),
        l2_index_path=Path(raw.get("l2_index_path", "./data/layers/knowledge/l2_index.json")),
